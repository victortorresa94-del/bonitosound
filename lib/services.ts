...
export const services: Record<string, Service> = {
  ...
  producciones: {
    ...
    faq: [
      ...
      { q: "¿Qué incluye la producción técnica de un evento?", a: "Lo que hace falta para que lo del deck ocurra de verdad: sonido, escenario, luces y la logística que lo sostiene. Con equipo propio, para que no vaya cada cosa por su lado." },
      { q: "¿Trabajáis en toda España?", a: "Sí. Tenemos base en Sabadell (Barcelona) y movemos eventos y giras por todo el país; también hemos trabajado fuera." },
      { q: "¿Qué tipo de eventos producís?", a: "Activaciones y experiencias de marca con música en directo, y también giras y directos de artista. Puedes ver algunos casos en la sección de eventos." },
    ],
